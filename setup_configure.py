...
class configure(Command):
    ...
    user_options = [('hdf5=', 'h', 'Custom path to HDF5'),
                    ...
                    ('mpi-include-dir=', None, 'MPI include dir'),
    ...
    def run(self):
        ...
        if self.mpi_include_dir is not None:
            dct['cmd_mpi-include-dir'] = self.mpi_include_dir
        ...
        if self.mpi_include_dir is None:
            self.mpi_include_dir = oldsettings.get('cmd_mpi-include-dir')
        ...
        print(" MPI Include dir: " + repr(self.mpi_include_dir))
